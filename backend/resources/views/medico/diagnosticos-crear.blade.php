...
<head>
    ...
    <title>E&M Laboratorio | Nuevo Diagnóstico</title>
...
<div class="dashboard-layout">
    ...
    <main class="main-content">
        <div class="page-header">
            <h1><i class="fas fa-plus-circle"></i> Nuevo diagnóstico</h1>
            <p>Registra un nuevo diagnóstico para tu paciente</p>
        </div>

        <div class="form-container">
            <form method="POST" action="{{ route('medico.diagnosticos.store') }}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" class="form-control" required placeholder="Ej: Hipertensión arterial">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="descripcion" class="form-control" rows="5" required placeholder="Describe el diagnóstico, síntomas, observaciones..."></textarea>
                </div>
