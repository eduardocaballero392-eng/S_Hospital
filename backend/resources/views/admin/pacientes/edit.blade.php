...
<head>
    ...
    <title>E&M Laboratorio | Editar Paciente</title>
        ...
        <div class="form-container">
            <form method="POST" action="{{ route('admin.pacientes.update', $paciente->id) }}">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="medico_asignado_id" class="form-control">
                            ...
                            @foreach($medicos ?? [] as $medico)
                                <option value="{{ $medico->id }}" {{ old('medico_asignado_id', $paciente->medico_asignado_id) == $medico->id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <select name="estado" class="form-control" required>
                            <option value="1" {{ old('estado', $paciente->usuario->estado ?? 1) == 1 ? 'selected' : '' }}>Activo</option>
                            <option value="0" {{ old('estado', $paciente->usuario->estado ?? 0) == 0 ? 'selected' : '' }}>Inactivo</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="direccion" class="form-control" rows="3">{{ old('direccion', $paciente->direccion) }}</textarea>
